...
```{r out.width="100%"}
#| fig-cap: "(Süddeutsche Zeitung)"
#| fig-link: <https://www.sueddeutsche.de/muenchen/oktoberfest-muenchen-corona-zahlen-anstieg-1.5664515?utm_source=Twitter&utm_medium=twitterbot&utm_campaign=1.5664515>
knitr::include_graphics("pictures/lebkuchenherzen_sueddeutsche_de_6TAFlTln.jpg")
```
...
:::rmdnote
**Textualität** (oder auch: *Texthaftigkeit*) ist die Gesamtheit der wesenhaften Merkmale von Texten. 
...
```{r}
#| fig-cap: "(Spiegel online)"
#| fig-link: <https://www.spiegel.de/geschichte/angela-merkel-portraet-aus-dem-jahr-2000-das-eiserne-maedchen-a-1131489.html>
